...
namespace WebApiOauth2.Helper_Code.OAuth2
{
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>  
        // TODO: (1)change StoreEntities with the context of the dataBase
        private onlineStorePlatformEntities databaseManager = new onlineStorePlatformEntities();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            // TODO: (2)write the query to get user role from the datBase
            var user = from User in databaseManager.Users where User.email == usernameVal && User.password == passwordVal select User.role ;
            ...
            // TODO: (3)change admin to the value that contain the role of the user
            claims.Add(new Claim(ClaimTypes.Role,userInfo ));
